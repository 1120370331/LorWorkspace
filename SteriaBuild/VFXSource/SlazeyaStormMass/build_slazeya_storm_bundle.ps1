...
$preview = Join-Path $repo 'preview_exports/slazeya_storm_mass/round2'
...
if (!(Select-String -LiteralPath $log -SimpleMatch 'SLAZEYA_ROUND2_BUILD_PREVIEW_PASS' -Quiet)) { throw "This run's Round2 success marker absent: $log" }
