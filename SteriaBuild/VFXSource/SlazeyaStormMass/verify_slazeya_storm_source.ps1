...
Check ($effect -match 'isRunning = true' -and $driver -match 'GatherDuration = 1.35f' -and $driver -match 'TailDuration = 1.20f') 'R4 frozen gate and tail durations'
...
Check ($shader -match '_FoamGather' -and $shader -match 'transport') 'original water surface transported into the 3D core'
...
Check ($builder -match 'burstAge' -and $builder -match 'round4' -and $build -match 'LastWriteTimeUtc') 'R4 output, callback-relative samples, fresh log validation'
